...
namespace
{
    ...
    // Matches orbital_view.cpp/atom_view.cpp's own kProtonColor -- kept independent (not
    // shared via a header) since each already defines this as a private local constant.
